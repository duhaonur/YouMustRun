...
public class PlayerMove : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        adCounter = PlayerPrefs.GetInt("ShowAd");
        adCounter++;
        PlayerPrefs.SetInt("ShowAd", adCounter);

        if (PlayerPrefs.GetInt("ShowAd") > 7)
        {
    ...
    public void Death()
    {
        ...
        GetComponent<Score>().AchievementController();
        PlayGamesController.Instance.SaveCloud();
        Social.ReportProgress(GPGSIds.achievement_first_failure, 100.0f, (bool success) => { });
    }
}
